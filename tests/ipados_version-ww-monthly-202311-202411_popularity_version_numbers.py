...
# Read the CSV file
file_path = 'ipados_version-ww-monthly-202311-202411-bar.csv'
...
ax.set_xlabel('iPadOS Version')
ax.set_ylabel('Market Share (%)')
fig.suptitle('iPadOS Version Market Share (Nov 2023 - Nov 2024)', fontsize=16, fontweight='bold')
ax.set_title('Sorted by iPadOS Version', ha='center')
...
fig.tight_layout()
# plt.show() 
fig.savefig('ipados_version-ww-monthly-202311-202411_popularity_version_numbers', dpi=300)